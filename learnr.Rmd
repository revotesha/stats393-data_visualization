...
```{r include=FALSE}
# this was used to launch assignment03 found here:
# https://revotesha.shinyapps.io/learnr
```
...
knitr::include_graphics("/images/piechart_one.png", dpi = 400)
```

```{r echo=FALSE, out.width="400px", fig.align="center"}
knitr::include_graphics("/images/piechart_two.png", dpi = 400)
```

<br/>

... to having to look at only this here ...

<br/>

```{r echo=FALSE, out.width="400px", fig.align="center"}
knitr::include_graphics("/images/barchart.png", dpi = 400)
```

<br/>

... or, if one still wants pie charts, this here ...

<br/>

```{r echo=FALSE, out.width="400px", fig.align="center"}
knitr::include_graphics("/images/two_piecharts.png", dpi = 400)
```

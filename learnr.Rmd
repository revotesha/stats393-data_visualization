...
knitr::include_graphics("www/piechart_one.png", dpi = 500)
```

```{r echo=FALSE, out.width="500px", fig.align="center"}
knitr::include_graphics("www/piechart_two.png", dpi = 500)
```
...
```{r echo=FALSE, out.width="500px", fig.align="center"}
knitr::include_graphics("www/barchart.png", dpi = 500)
```
...
```{r echo=FALSE, out.width="500px", fig.align="center"}
knitr::include_graphics("www/two_piecharts.png", dpi = 500)
```

...
![](../Images/piechart_one.png)

![](../Images/piechart_two.png)
...
``grid.arrange()`` combines the plots. Run the code to generate our final plot
object. You should re-run this chunk everything you change ``left_plot`` or ``right_plot``.

```{r question-eleven, exercise=TRUE, exercise.setup="prepare-graph-four", exercise.lines=5}

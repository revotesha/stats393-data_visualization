...
Link to original data: https://oasishub.co/dataset/usa-tornado-historical-tracks
...
```{r}
knitr::include_graphics("../Images/piechart_one.png", dpi = NA)
```

```{r}
knitr::include_graphics("../Images/piechart_two.png", dpi = NA)
```

...
```{r}
quest_res_df_narrow = gather(quest_res_df, "reaction_one", "reaction_two", "reaction_three", "reaction_four", key = "trial", value = "reaction")
#View(quest_res_df_narrow)
```

#### Animated Change in Reaction:
```{r}
animated <- ggplot(quest_res_df_narrow) + 

...
color_pallete <- c(
  ...
  "I don't like chocolate" = "indianred1", #arbitrary
  "Milk chocolate" = "saddlebrown",
  "Dark chocolate" = "chocolate4"
)

ggplot(quest_res_df) + 
  geom_bar(aes(x = fav_chocolate, fill = fav_chocolate)) +
  labs(x = "Favorite Chocolate" , title = "Number of students who prefer a certain type of chocolate") +
  theme(legend.position = "right",
        legend.title = element_text(face="bold"),
        plot.title = element_text(hjust = 0.5)) +
  scale_fill_manual(
